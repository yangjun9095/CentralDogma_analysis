...
%
% The author would like to thank Guangning Tan for helpful feedback. If you
% want to use the Auction algorithm without Matlab, please check out
% Guangning Tan's C++ interface, available here:
% https://github.com/tgn3000/fastAuction .
%
